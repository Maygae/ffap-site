// Ajoute 2 oeuvres a la fiche de Martine de Santis (galerie).
// Les images doivent se trouver dans le dossier photos-a-importer/ a la racine de ffap-backend.
// Usage : node src/scripts/upload-oeuvres-martine.js
...
const NOM_ARTISTE = 'Martine de Santis';

const oeuvres = [
  { titre: 'Sculpture en cours de creation', fichier: 'oeuvre-martine-sculpture.png', type: 'image/png' },
  { titre: 'Gorille', fichier: 'oeuvre-martine-gorille.jpg', type: 'image/jpeg' },
];
...
async function main() {
  ...
  for (const { titre, fichier, type } of oeuvres) {
